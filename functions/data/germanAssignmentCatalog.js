const GERMAN_ASSIGNMENT_COURSE_DICTIONARY = {
  A1: {
    ...
    "A1-1.2": { assignment_id: "A1 5", week: "Week Three", day: "Day 5", assignment: true, assignmentDay: 5, date: "Monday, 23 March 2026", topic: "Introducing Yourself", chapter: "1.2" },
    "A1-2.3": { assignment_id: "A1 6", week: "Week Three", day: "Day 6", assignment: true, assignmentDay: 6, date: "Tuesday, 24 March 2026", topic: "Family and Hobbies", chapter: "2.3" },
    ...
    "A1-3.6": { assignment_id: "A1 14", week: "Week Six", day: "Day 14", assignment: true, assignmentDay: 14, date: "Monday, 13 April 2026", topic: "Modal Verbs", chapter: "3.6" },
    "A1-4.7": { assignment_id: "A1 15", week: "Week Six", day: "Day 15", assignment: true, assignmentDay: 15, date: "Tuesday, 14 April 2026", topic: "Imperatives", chapter: "4.7" },
    ...
    "A1-5.9": { assignment_id: "A1 19", week: "Week Seven", day: "Day 19", assignment: true, assignmentDay: 19, date: "Wednesday, 22 April 2026", topic: "Goethe A1 Speaking Practice", chapter: "5.9" },
    "A1-6.10": { assignment_id: "A1 20", week: "Week Eight", day: "Day 20", assignment: true, assignmentDay: 20, date: "Monday, 27 April 2026", topic: "Schreiben & Sprechen (Intro to letter writing)", chapter: "6.10" },
    ...
    "A1-14.2": { assignment_id: "A1 23", week: "Week Nine", day: "Day 23", assignment: true, assignmentDay: 23, date: "Monday, 04 May 2026", topic: "Dative and Accusative Verbs", chapter: "14.2" },
    "A1-8.13": { assignment_id: "A1 24", week: "Week Nine", day: "Day 24", assignment: true, assignmentDay: 24, date: "Tuesday, 05 May 2026", topic: "Schreiben & Sprechen", chapter: "8.13" },
  },
  A2: {
...
const getAssignmentSequenceForLevel = (level) => {
  const normalizedLevel = String(level || "").toUpperCase();
  const levelDictionary = GERMAN_ASSIGNMENT_COURSE_DICTIONARY[normalizedLevel];
...
module.exports = {
  GERMAN_ASSIGNMENT_COURSE_DICTIONARY,
