...
const nativeDraftWorkbook = workbook.includes('data-a1-chapter3-draft-guidance="true"');

if (nativeDraftWorkbook) {
...
console.log(`Applied A1 Day 7 Course Book audit fixes${nativeDraftWorkbook ? " for native draft workbook" : ""}.`);
