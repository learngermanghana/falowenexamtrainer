...
const completionGuardMarker = `const onSubmitCapture = (event) => {`;
if (!runtimeSource.includes(completionGuardMarker)) {
...
if (!runtimeSource.includes("Complete your workbook before submitting")) {
...
if (!runtimeSource.includes("Choose one answer for each question")) {
