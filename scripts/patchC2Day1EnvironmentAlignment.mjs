...
const registryPath = path.join(root, "web/src/components/SelfLearningLessonRegistry.js");
const standardPath = path.join(root, "web/src/data/c2ExamStandardContent.js");
...
const currentCircularEconomy = standardSource.includes('Kreislaufwirtschaft und Wegwerfgesellschaft') && standardSource.includes('topicKnowledge');

if (registrySource.includes(unifiedC2Renderer) && currentCircularEconomy) {
  console.log("Current unified C2 Day 1 circular-economy content detected; legacy Umwelt alignment patch skipped.");
} else {
