...
path = Path('web/src/components/TwoCasePrepositionsPageLegacy.js')
...
('''        <p style={{ margin: 0, opacity: 0.85 }}>
        ...
        </p>''', '''        <p style={{ margin: 0, color: "#475569" }}>
