...
const registryPath = path.join(path.resolve(path.dirname(fileURLToPath(import.meta.url)), ".."), "web/src/components/SelfLearningLessonRegistry.js");
const registrySource = fs.readFileSync(registryPath, "utf8");
const unifiedC2Renderer = 'if (normalizedLevel === "C2" && day >= 1 && day <= 28) page = <C2UnifiedGuidedWorkbookPage';

if (registrySource.includes(unifiedC2Renderer)) {
  console.log("C2 unified workbook already owns Days 1-28; retired C1-style C2 learning-mechanics patch chain skipped.");
} else {
