...
import C1Day1WillkommenSelbstlernstartPage from "./components/C1Day1WillkommenSelbstlernstartPage";
    ...
    <div className="app-shell" style={styles.container}>
      ...
      <main className="layout-main" style={{ minWidth: 0 }}>
        <Routes>
          ...
          <Route path="/campus/course/c1-day-1-willkommen-selbstlernstart" element={<C1Day1WillkommenSelbstlernstartPage />} />
