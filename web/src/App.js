...
import C1Day10MigrationUndIntegrationWorkbookPage from "./components/C1Day10MigrationUndIntegrationWorkbookPage";
    ...
    <div className="app-shell" style={styles.container}>
      ...
      <main className="layout-main" style={{ minWidth: 0 }}>
        <Routes>
          ...
          <Route path="/campus/course/c1-day-10-migration-und-integration-workbook" element={<C1Day10MigrationUndIntegrationWorkbookPage />} />
