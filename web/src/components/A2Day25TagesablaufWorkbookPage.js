...
const annaQuestions = [
  {
    ...
    options: ["a) kurz vor 7 Uhr", "b) nie vor 7 Uhr", "c) immer nach 7 Uhr", "d) kurz nach 7 Uhr"],
  },
  {
    stem: "Was isst Anna zum Frühstück?",
    options: [
      "a) Cornflakes und Toast mit Butter",
      "b) nichts",
      "c) Brot mit Käse oder Wurst",
      "d) Müsli oder Toast mit Marmelade",
    ],
  },
  {
    stem: "Was macht sie nicht morgens, bevor sie zur Schule geht?",
    options: ["a) zur Toilette gehen", "b) Hausaufgaben", "c) das Bett machen", "d) duschen"],
  },
  {
    stem: "Wann kommt sie nach Hause?",
    options: [
      "a) am Nachmittag",
      "b) nachdem sie die Hausaufgaben gemacht hat",
      "c) nach dem Abendessen",
      "d) kurz vor dem Abendessen",
    ],
  },
  {
    stem: "Was macht sie nach den Hausaufgaben?",
    options: ["a) schlafen", "b) Freunde treffen", "c) Sport", "d) lernen"],
  },
];

const meyerQuestions = [
  {
    stem: "Welches Reiseziel wählt Familie Meyer in diesem Jahr?",
    options: ["a) Österreich", "b) Deutschland", "c) die Schweiz", "d) Italien"],
  },
  {
    stem: "Womit fährt Familie Meyer in den Urlaub?",
    options: ["a) mit dem Taxi", "b) mit dem Bus", "c) mit dem Auto", "d) mit dem Zug"],
  },
  {
    stem: "Wo steigen Herr und Frau Meyer aus dem Zug?",
    options: [
      "a) an einem kleinen Bahnhof",
      "b) an einem großen Hotel",
      "c) am Flughafen",
      "d) an einer kleinen Raststätte",
    ],
  },
  {
    stem: "Was erhalten sie an der Rezeption des Hotels?",
    options: ["a) einen schönen Blumenstrauß", "b) eine Fahrkarte", "c) einen Brief", "d) einen Zimmerschlüssel"],
  },
  {
    stem: "Warum ist Herr Meyer unzufrieden?",
    options: ["a) es gibt kein freies Zimmer", "b) das Zimmer ist zu klein", "c) das Zimmer ist zu groß", "d) das Hotel ist zu klein"],
  },
];
    ...
    {questions.map((question, index) => (
      <div key={question.stem} style={questionCardStyle}>
        ...
        {question.options.map((option) => (
          <span key={option} style={{ lineHeight: 1.55 }}>{option}</span>
        ))}
      </div>
    ))}
  </div>
    ...
    <div style={{ ...styles.container, display: "grid", gap: 16 }}>
      <div style={card}>
        ...
        <p style={{ ...styles.subtitle, margin: 0 }}>
          Four-part workbook: speaking, writing and two reading-comprehension exercises. There is no Hören assignment in this workbook.
        </p>
      ...
      {activeTab === "sprechen" && (
        <div style={card}>
          <img
            ...
            alt="Students discussing their day in class"
            loading="lazy"
            style={{ width: "100%", borderRadius: 10, maxHeight: 260, objectFit: "cover" }}
          />
          <h2 style={sectionTitle}>Teil 1 · Sprechen · Group Practice</h2>
          <SpeakingMindMap config={getA2SpeakingMindMap(25)} />
          <p style={{ margin: 0, lineHeight: 1.7 }}>
            In this chapter, we&apos;ll engage in group exercises discussing daily routines.
          </p>
          ...
          <ol style={listSpacing}>
            ...
            <li>
              <strong>Main Branches:</strong> Create six main branches:
          ...
          <ol style={listSpacing}>
            <li>
              <strong>Morgenroutine (Morning Routine)</strong>
              <ul style={listSpacing}>
                <li>Aufstehen (getting up)</li>
                <li>Zähne putzen (brushing teeth)</li>
                <li>Duschen (showering)</li>
                <li>Frühstücken (having breakfast)</li>
                <li>Anziehen (getting dressed)</li>
                <li>Zur Arbeit oder zur Schule gehen (going to work or school)</li>
              </ul>
            </li>
            <li>
              <strong>Arbeit/Schule (Work/School)</strong>
              <ul style={listSpacing}>
                <li>Arbeiten (working)</li>
                <li>E-Mails schreiben (writing emails)</li>
                <li>An Meetings teilnehmen (attending meetings)</li>
                <li>Unterricht haben (having lessons)</li>
                <li>Hausaufgaben machen (doing homework)</li>
                <li>Pause machen (taking a break)</li>
              </ul>
            </li>
            <li>
              <strong>Mittagspause (Lunch Break)</strong>
              <ul style={listSpacing}>
                <li>Mittagessen essen (eating lunch)</li>
                <li>Mit Kollegen oder Freunden sprechen (talking with colleagues or friends)</li>
                <li>Einkaufen gehen (going shopping)</li>
                <li>Spazieren gehen (taking a walk)</li>
              </ul>
            </li>
            <li>
              <strong>Nachmittag (Afternoon)</strong>
              <ul style={listSpacing}>
                <li>Weiterarbeiten (continuing work)</li>
                <li>Sport treiben (doing sports)</li>
                <li>Termine haben (having appointments)</li>
                <li>Kaffee trinken (having coffee)</li>
              </ul>
            </li>
            <li>
              <strong>Abendroutine (Evening Routine)</strong>
              <ul style={listSpacing}>
                <li>Abendessen kochen (cooking dinner)</li>
                <li>Nachrichten schauen (watching the news)</li>
                <li>Entspannen (relaxing)</li>
                <li>Duschen oder baden (taking a shower or bath)</li>
                <li>Ins Bett gehen (going to bed)</li>
              </ul>
            </li>
            <li>
              <strong>Freizeit und Hobbys (Free Time and Hobbies)</strong>
              <ul style={listSpacing}>
                <li>Bücher lesen (reading books)</li>
                <li>Musik hören (listening to music)</li>
                <li>Filme oder Serien schauen (watching movies or series)</li>
                <li>Spazieren gehen (going for a walk)</li>
                <li>Freunde treffen (meeting friends)</li>
                <li>Ein Instrument spielen (playing an instrument)</li>
              </ul>
            </li>
          </ol>
      ...
      {activeTab === "schreiben" && (
        <div style={card}>
          <img
            ...
            alt="Learner writing about a daily schedule"
            loading="lazy"
            style={{ width: "100%", borderRadius: 10, maxHeight: 260, objectFit: "cover" }}
          />
          ...
          <ol style={listSpacing}>
            <li>Beschreibe deinen Morgen und deinen Arbeits- oder Schultag.</li>
            <li>Erzähle, was du am Abend machst.</li>
            <li>Frage nach dem Tagesablauf deiner Freundin oder deines Freundes.</li>
          </ol>
          <div style={calloutStyle}>
            <strong>Writing practice guidance</strong>
            <p style={{ margin: 0 }}>
              Write a first draft, improve structure and connectors, and submit your final answer in the assignment submission area — not directly on this page.
            </p>
          </div>
      ...
      {activeTab === "lesen1" && (
        <div style={card}>
          <img
            ...
            alt="Reading comprehension exercise on a desk"
            loading="lazy"
            style={{ width: "100%", borderRadius: 10, maxHeight: 260, objectFit: "cover" }}
          />
          ...
          <QuestionList questions={annaQuestions} />
          <WorkbookSubmissionReminder />
          <PreparedCheckbox checked={prepared.lesen1} onChange={setPreparedFor("lesen1")} />
        </div>
      )}
      ...
      {activeTab === "lesen2" && (
        <div style={card}>
          <img
            src="https://images.unsplash.com/photo-1464863979621-258859e62245?auto=format&fit=crop&w=1600&q=80"
            alt="Reading a travel and hotel complaint text"
            loading="lazy"
            style={{ width: "100%", borderRadius: 10, maxHeight: 260, objectFit: "cover" }}
          />
          ...
          <QuestionList questions={meyerQuestions} />
          <WorkbookSubmissionReminder />
          <PreparedCheckbox checked={prepared.lesen2} onChange={setPreparedFor("lesen2")} />
        </div>
      )}
      ...
      {activeTab === "references" && (
        <WorkbookReferenceAnswers
          level="A2"
          lesson={{ title: "A2Day25Tagesablauf", level: "A2", workbookId: "A2Day25Tagesablauf" }}
