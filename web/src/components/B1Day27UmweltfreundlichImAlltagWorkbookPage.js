  ...
  return (
    <div style={{ ...styles.container, display: "grid", gap: 16 }}>
      ...
      {activeTab === "references" && (
        <WorkbookReferenceAnswers level="B1" lesson={{ title: "B1Day27UmweltfreundlichImAlltag", level: "B1", workbookId: "B1Day27UmweltfreundlichImAlltag" }} workbookId="B1Day27UmweltfreundlichImAlltag" />
      )}
