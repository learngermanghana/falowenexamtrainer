...
const summaries = {
  15: { title: "Bildung und lebenslanges Lernen: Zugang und Entwicklung", intro: "Dieses C1-Kapitel behandelt Weiterbildung als langfristigen Prozess. Es geht um digitale Lernangebote, soziale Unterschiede, Eigenverantwortung und die Frage, wie Bildung lebenslang zugänglich bleiben kann.", points: ["Bewerte Weiterbildung nicht nur individuell, sondern auch gesellschaftlich.", "Nutze argumentative Satzmuster und Nominalisierung, um Gründe, Einwände und Bedingungen präzise zu verbinden.", "Eine starke C1-Antwort zeigt Chancen, Hürden und konkrete Finanzierungs- oder Fördermöglichkeiten."], vocabulary: ["lebenslanges Lernen", "Weiterbildung", "Zugang", "Finanzierungsmodell", "soziale Mobilität"] },
  16: { title: "Technologie im Alltag: Komfort, Datenschutz und Abhängigkeit", intro: "Dieses C1-Kapitel analysiert, wie digitale Technologien den Alltag verändern. Der Fokus liegt auf Komfort, vernetzten Geräten, Datenverarbeitung, Datenschutz und digitaler Selbstbestimmung.", points: ["Beschreibe digitale Prozesse sachlich mit Passivformen.", "Unterscheide Komfortgewinn von neuer Abhängigkeit.", "Eine starke C1-Antwort wägt Nutzen, Datenschutz und Transparenz ab."], vocabulary: ["Datenverarbeitung", "vernetzt", "Datenschutz", "Transparenz", "digitale Abhängigkeit"] },
  17: { title: "Umwelt und Verantwortung: Nachhaltigkeit systematisch begründen", intro: "Dieses C1-Kapitel verbindet Klima, Konsum, Mobilität und politische Verantwortung. Ziel ist eine differenzierte Argumentation über individuelles Handeln und strukturelle Veränderungen.", points: ["Strukturiere deine Antwort mit Problem, Ursache, Folge und Lösung.", "Nutze Nominalstil, um Umweltprozesse präzise zu verdichten.", "Eine starke C1-Antwort vermeidet einfache Schuldzuweisungen und zeigt geteilte Verantwortung."], vocabulary: ["Emissionen", "Ressourcenverbrauch", "politische Rahmenbedingungen", "die Reduzierung", "nachhaltige Mobilität"] },
};
...
export default function C1Day15To17GuidedLessonPage({ lesson, canonicalLesson = null }) {
