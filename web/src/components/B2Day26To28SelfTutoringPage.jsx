...
import tutoring from "../data/b2Days26To28SelfTutoring";
...
const enhanceLesson = (lesson) => {
  const extra = tutoring[Number(lesson?.day || 0)];
...
export default function B2Day26To28SelfTutoringPage({ lesson, canonicalLesson = null }) {
  ...
  return <div style={{ ...styles.container, display:"grid", gap:18 }}>
    ...
    {active === "learn" ? <>
      ...
      <B2Day25To28GrammarNotes day={day} checked={progress.learnNotesDone} onCheckedChange={(checked) => setProgress((old) => ({ ...old, learnNotesDone:checked }))} />
