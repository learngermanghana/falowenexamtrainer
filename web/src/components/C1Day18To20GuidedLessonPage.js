...
const summaries = {
  18: { title: "Gesellschaft und Zusammenhalt: Solidarität konkret erklären", intro: "Dieses C1-Kapitel behandelt Gemeinschaft, soziale Konflikte und Solidarität. Ziel ist, gesellschaftliche Spannungen differenziert zu beschreiben und konkrete Bedingungen für Zusammenhalt zu nennen.", points: ["Analysiere, warum sich Gruppen ausgeschlossen fühlen können.", "Nutze adversative und konzessive Strukturen, um Spannungen fair darzustellen.", "Eine starke C1-Antwort verbindet Solidarität mit Teilhabe, Bildung und Mitbestimmung."], vocabulary: ["gesellschaftlicher Zusammenhalt", "Solidarität", "soziale Spaltung", "Teilhabe", "Mitbestimmung"] },
  19: { title: "Arbeit der Zukunft: Wandel vorsichtig prognostizieren", intro: "Dieses C1-Kapitel betrachtet Digitalisierung, Automatisierung und neue Arbeitsmodelle. Du erklärst, welche Kompetenzen wichtiger werden und welche sozialen Risiken entstehen können.", points: ["Formuliere Prognosen vorsichtig statt absolut.", "Nutze Futur, dürfte/könnte und Modalpassiv für differenzierte Zukunftsaussagen.", "Eine starke C1-Antwort wägt Effizienz, Flexibilität und Belastung ab."], vocabulary: ["Automatisierung", "flexible Arbeitsmodelle", "digitale Kompetenzen", "dürfte", "Arbeitsbelastung"] },
  20: { title: "Digitale Gesundheit: Chancen und Datenschutz abwägen", intro: "Dieses C1-Kapitel verbindet Medizin, Apps, Datenschutz und Zugang zu Versorgung. Wichtig ist eine sachliche Bewertung digitaler Gesundheitsangebote.", points: ["Beschreibe digitale Gesundheitsprozesse mit Passiv und Nominalstil.", "Erkläre Chancen wie Beratung, Effizienz und Zugang.", "Eine starke C1-Antwort zeigt auch Risiken bei Datenschutz, Qualität und sozialer Ungleichheit."], vocabulary: ["digitale Gesundheit", "Gesundheitsdaten", "Datenschutz", "die Speicherung", "medizinische Qualität"] },
};
...
const day18Prompts = {
  ...
  writingIdeas: [
    "Einleitung: gesellschaftliche Relevanz und eigene These",
    "Ursachen sozialer Spaltung erklären",
    "Folgen für Vertrauen, Solidarität und Demokratie darstellen",
    "Gegenargument zu Kosten oder Eigenverantwortung abwägen",
    "eine konkrete Maßnahme bewerten und ein ausgewogenes Fazit formulieren",
  ],
};
