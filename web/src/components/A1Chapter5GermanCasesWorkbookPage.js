    ...
    <div style={{ ...styles.container, display: "grid", gap: 16 }}>
      <div style={card}>
        ...
        <p style={{ ...styles.subtitle, margin: 0 }}>
          German Cases · Chapter 5. Prepare all answers in your notebook first,
          then submit them in the assignment submission tab.
        </p>
      ...
      {activeTab === "vocabulary" && (
        <div style={card}>
          ...
          >
            Important: Do not write only a, b, c, etc. as your answers. Write
            the full English meaning for each German noun, for example: der
            Tisch = the table.
          </p>

          <p style={{ margin: 0, color: "#4b5563", lineHeight: 1.6 }}>
            Exercise only: do not reveal the answers on this page.
          </p>
        </div>
      )}
        ...
        <div style={card}>
          ...
          >
            ...
            <ul style={listSpacing}>
              ...
              <li>
                Der Nominativ zeigt das Subjekt im Satz (wer oder was etwas
                tut).
              </li>
            </ul>
          </div>
      ...
      {activeTab === "accusative" && (
        <div style={card}>
          ...
          <p style={{ margin: 0, lineHeight: 1.7 }}>
            <strong>Accusative Articles</strong>: den (masculine), die
            (feminine), das (neuter)
          </p>
          ...
          <p style={{ margin: 0, color: "#4b5563" }}>
            Kein Texteingabefeld hier: Write your final responses in your
            notebook and submit through the assignment submission tab.
          </p>
        </div>
      )}
    </div>
