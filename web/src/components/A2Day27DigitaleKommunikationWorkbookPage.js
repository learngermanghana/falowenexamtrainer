  ...
  return (
    <div style={{ ...styles.container, display: "grid", gap: 16 }}>
      ...
      {activeTab === "references" && (
        <WorkbookReferenceAnswers level="A2" lesson={{ title: "A2Day27DigitaleKommunikation", level: "A2", workbookId: "A2Day27DigitaleKommunikation" }} workbookId="A2Day27DigitaleKommunikation" />
      )}
