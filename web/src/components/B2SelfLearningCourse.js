...
const B2_SELF_LEARNING_PLAN = [
  ...
  },
  {
    ...
    grammar: "Konjunktiv II für höfliche Bitten und hypothetische Situationen",
    speakingTask: "Erkläre, was gute Kommunikation in Beziehungen ausmacht, und reagiere höflich auf ein Missverständnis.",
    writingTask: "Schreibe einen B2-Meinungsbeitrag über respektvolle Kommunikation in Beziehungen.",
    readingTask: "Lies einen Text über Beziehungen oder Kommunikation und markiere nützliche Redemittel.",
    listeningTask: "Höre einen Beitrag über Konflikte oder Freundschaft und notiere höfliche Reaktionen mit Konjunktiv II.",
    keywords: ["Beziehung", "Kommunikation", "Missverständnis", "Bitte", "Vorschlag", "Konflikt"],
  },
  {
    day: 3,
