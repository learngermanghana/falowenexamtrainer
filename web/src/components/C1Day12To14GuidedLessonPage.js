...
import C1Day12To14GrammarNotes from "./C1Day12To14GrammarNotes";
...
const summaries = {
  ...
  13: { title: "Mehrsprachigkeit: Sprache, Bildung und Identität", intro: "C1 Day 13 analysiert Mehrsprachigkeit als Ressource für Bildung, Beruf und Identität. Gleichzeitig werden mögliche Herausforderungen im Bildungssystem reflektiert.", points: ["Beschreibe Mehrsprachigkeit differenziert und ohne Defizitperspektive.", "Nutze Nominalstil und Relativsätze, um komplexe Zusammenhänge zu verdichten.", "Eine starke C1-Antwort zeigt Vorteile, Herausforderungen und Fördermöglichkeiten."], vocabulary: ["Mehrsprachigkeit", "der Spracherwerb", "die Ressource", "sprachliche Vielfalt", "das Bildungssystem"] },
  14: { title: "Innovation und Zukunft: Chancen und Risiken prognostizieren", intro: "C1 Day 14 behandelt technologischen Wandel, Zukunftsfragen und gesellschaftliche Verantwortung. Es geht darum, Entwicklungen vorsichtig zu prognostizieren und Bedingungen für sinnvolle Innovation zu nennen.", points: ["Formuliere Prognosen vorsichtig und differenziert.", "Nutze Modalpassiv und Bedingungssätze, um notwendige Regeln zu erklären.", "Eine starke C1-Antwort wägt Fortschritt, Ethik, Datenschutz und Zugangsgerechtigkeit ab."], vocabulary: ["die Innovation", "künstliche Intelligenz", "dürfte", "Modalpassiv", "Zugangsgerechtigkeit"] },
};
