...
const summaries = {
  12: { title: "Freizeit und Kultur: Teilhabe und Lebensqualität", intro: "C1 Day 12 betrachtet Freizeit und Kultur als gesellschaftliche Ressourcen. Der Fokus liegt auf Zugang, kultureller Vielfalt, sozialer Teilhabe und Lebensqualität.", points: ["Bewerte kulturelle Angebote nicht nur persönlich, sondern gesellschaftlich.", "Nutze erweiterte Vergleichs- und Bewertungsstrukturen für eine differenzierte Stellungnahme.", "Eine starke C1-Antwort verbindet Kultur mit Bildung, Begegnung und sozialer Gerechtigkeit."], vocabulary: ["kulturelle Teilhabe", "Lebensqualität", "niedrigschwellig", "im Hinblick auf", "Perspektivwechsel"] },
  13: { title: "Mehrsprachigkeit: Sprache, Bildung und Identität", intro: "C1 Day 13 analysiert Mehrsprachigkeit als Ressource für Bildung, Beruf und Identität. Gleichzeitig werden mögliche Herausforderungen im Bildungssystem reflektiert.", points: ["Beschreibe Mehrsprachigkeit differenziert und ohne Defizitperspektive.", "Nutze indirekte Rede und Distanzmarker, um fremde Positionen sauber von deiner Bewertung zu trennen.", "Eine starke C1-Antwort zeigt Vorteile, Herausforderungen und realistische Fördermöglichkeiten."], vocabulary: ["Mehrsprachigkeit", "der Spracherwerb", "die Ressource", "sprachliche Vielfalt", "das Bildungssystem"] },
  14: { title: "Innovation und Zukunft: Chancen und Risiken prognostizieren", intro: "C1 Day 14 behandelt technologischen Wandel, Zukunftsfragen und gesellschaftliche Verantwortung. Es geht darum, Entwicklungen vorsichtig zu prognostizieren und Bedingungen für sinnvolle Innovation zu nennen.", points: ["Formuliere Prognosen vorsichtig und differenziert.", "Nutze Futur I, Futur II und Prognosemarker funktional.", "Eine starke C1-Antwort wägt Fortschritt, Ethik, Datenschutz und Zugangsgerechtigkeit ab."], vocabulary: ["die Innovation", "künstliche Intelligenz", "voraussichtlich", "Futur II", "Zugangsgerechtigkeit"] },
};
...
export default function C1Day12To14GuidedLessonPage({ lesson, canonicalLesson = null }) {
