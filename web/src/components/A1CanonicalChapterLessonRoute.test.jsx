...
describe("A1CanonicalChapterLessonRoute", () => {
  test("routes Kapitel 1.1 to its own workbook even when stale state says 0.2", async () => {
  ...
  test("routes Kapitel 0.2 to the alphabet workbook", async () => {
    renderCanonicalRoute({
  ...
  test("preserves required workbook and optional route query parameters", async () => {
    renderCanonicalRoute({
  ...
  test("destination resolution is chapter-owned and does not accept navigation state", () => {
