...
const speakingHelp = {
  ...
  13: {
    ...
    instructions: [
      "Answer the five mind-map branches in order and connect them into one response.",
      "Give one concrete example from your education or experience.",
      "Finish with a short polite sentence.",
    ],
    phraseGroups: [
      { title: "Vorstellung", items: ["Guten Tag, vielen Dank für die Einladung.", "Mein Name ist ... und ich wohne in ...", "Ich interessiere mich für ..."] },
      { title: "Ausbildung", items: ["Ich habe eine Ausbildung als ... gemacht.", "Ich habe meinen Abschluss in ... gemacht.", "Zusätzlich habe ich einen Kurs in ... besucht."] },
      { title: "Berufserfahrung", items: ["Ich habe bereits im Verkauf gearbeitet.", "Ich habe ein Praktikum in einem Büro gemacht.", "Dort musste ich ..."] },
      { title: "Fähigkeiten", items: ["Ich bin zuverlässig und freundlich.", "Ich kann gut mit Kunden sprechen.", "Ich arbeite gern im Team."] },
      { title: "Motivation", items: ["Ich interessiere mich für diese Stelle, weil ...", "Ich möchte mich beruflich weiterentwickeln.", "Vielen Dank für das Gespräch."] },
    ],
    vocabulary: ["das Vorstellungsgespräch", "die Ausbildung", "die Berufserfahrung", "die Fähigkeit", "zuverlässig", "selbstständig", "teamfähig", "sich interessieren für", "sich weiterentwickeln", "die Einladung"],
    modelAnswer: "Guten Tag, vielen Dank für die Einladung. Mein Name ist Ama Mensah und ich wohne in Accra. Ich habe eine Ausbildung als Bürokauffrau gemacht und bereits im Verkauf gearbeitet. Dort konnte ich Erfahrung mit Kunden sammeln und musste auch Bestellungen organisieren. Ich bin freundlich, zuverlässig und arbeite gern im Team. Ich interessiere mich für diese Stelle bei Amazon, weil ich mich beruflich weiterentwickeln möchte. Vielen Dank für das Gespräch.",
  },
  14: {
    title: "More speaking help: Beruf und Karriere",
    instructions: [
      "Answer the five mind-map branches in order and connect them into one career story.",
      "Give one concrete example of a task or experience.",
      "Use um ... zu for your future career goal if possible.",
    ],
    phraseGroups: [
      { title: "Beruf", items: ["Ich bin Verkäuferin.", "Ich arbeite in einem Einkaufszentrum.", "Ich arbeite im Kundenservice."] },
      { title: "Aufgaben", items: ["Ich berate Kunden.", "Ich organisiere Bestellungen.", "Ich arbeite gern mit anderen zusammen."] },
      { title: "Weg zum Beruf", items: ["Ich habe eine Ausbildung als ... gemacht.", "Danach habe ich ein Praktikum gemacht.", "Dann habe ich mich bei ... beworben."] },
      { title: "Stärken", items: ["Ich bin zuverlässig und organisiert.", "Ich kann gut mit Kunden sprechen.", "Ich arbeite gern im Team."] },
      { title: "Zukunft", items: ["Ich möchte Kurse besuchen, um neue Fähigkeiten zu lernen.", "Später möchte ich mehr Verantwortung übernehmen.", "In fünf Jahren möchte ich ..."] },
    ],
    vocabulary: ["der Beruf", "der Arbeitsplatz", "die Aufgabe", "die Ausbildung", "das Praktikum", "sich bewerben", "die Stärke", "zuverlässig", "Verantwortung übernehmen", "sich weiterentwickeln"],
    modelAnswer: "Ich bin Verkäuferin und arbeite in einem Einkaufszentrum. Dort berate ich Kunden und organisiere Bestellungen. Nach meiner Ausbildung habe ich ein Praktikum gemacht und mich dann um diese Stelle beworben. Ich bin zuverlässig und kann gut im Team arbeiten. In Zukunft möchte ich eine Weiterbildung machen, um mehr Verantwortung zu übernehmen.",
  },
  15: {
