  ...
  return (
    <div style={{ ...styles.container, display: "grid", gap: 16 }}>
      ...
      {activeTab === "references" && (
        <WorkbookReferenceAnswers level="B1" lesson={{ title: "B1Day24KonsumNachhaltigkeit", level: "B1", workbookId: "B1Day24KonsumNachhaltigkeit" }} workbookId="B1Day24KonsumNachhaltigkeit" />
      )}
