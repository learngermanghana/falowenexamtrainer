    ...
    <div style={{ ...styles.container, display: "grid", gap: 16 }}>
      <div style={cardStyle}>
        ...
        <h1 style={{ ...styles.title, marginBottom: 0 }}>
          A1 · Day 3 Workbook · Introducing Yourself and Reviewing Pronouns
        </h1>
        <p style={{ ...styles.subtitle, margin: 0 }}>Chapter 1.2</p>
      ...
      <section style={sectionStyle}>
        <img
          ...
          alt="Student reading and writing German workbook notes"
          loading="lazy"
          style={imageStyle}
        />
        ...
        <p style={{ margin: 0, lineHeight: 1.7 }}>
          ...
          <br />Hallo! Ich heiße Anna. Ich komme aus Spanien und ich wohne in Madrid. Wie heißt du? Woher kommst du?
          Wo wohnst du? Mein Freund Peter kommt aus Deutschland und wohnt in Berlin. Er heißt Peter.
        </p>
        <p style={{ margin: 0, lineHeight: 1.7 }}>
          <strong>Exercise: Complete the Sentences</strong> (use the verbs <em>heißen</em>, <em>wohnen</em>, and <em>kommen</em>.
          Conjugate each verb to match the pronoun.)
        </p>
      ...
      <section style={sectionStyle}>
        <h2 style={{ margin: 0 }}>Teil 2 · Schreiben &amp; Fragen</h2>
        <div style={questionBoxStyle}>
          <strong>Writing Task: Introduce Yourself (16.6)</strong>
          <p style={{ margin: 0, lineHeight: 1.7 }}>
            Using information about yourself, write a short paragraph and include the following details:
          </p>
          <ol style={{ margin: 0, paddingLeft: 20, lineHeight: 1.7 }}>
            <li>Your name</li>
...
export default A1Day3Kapitel12WorkbookPage;
