...
const config = {
  ...
  questions: [
    ...
    q("Choose the correct sentence with deshalb.", ["Ich habe morgen eine Prüfung, deshalb ich lerne heute.", "Ich habe morgen eine Prüfung, deshalb lerne ich heute.", "Ich habe morgen eine Prüfung, deshalb heute ich lerne."], 1, "After deshalb, the verb comes directly after the connector."),
    q("Choose the correct indirect question.", ["Ich weiß nicht, ob kommt er heute.", "Ich weiß nicht, er ob heute kommt.", "Ich weiß nicht, ob er heute kommt."], 2, "Ob sends the verb to the end."),
    ...
    q("Choose the correct Präteritum sentence.", ["Als Kind hatten ich viel Zeit.", "Als Kind hatte ich viel Zeit.", "Als Kind habe ich viel Zeit hatte."], 1, "The Präteritum form of haben for ich is hatte."),
    q("Choose the correct past modal sentence.", ["Ich muss gestern lange arbeiten.", "Ich gemusst gestern lange arbeiten.", "Ich musste gestern lange arbeiten."], 2, "Musste is the correct past form of müssen for ich."),
    ...
    q("Which sentence describes a fixed location?", ["Das Bild hängt an die Wand.", "Das Bild hängt an der Wand.", "Das Bild hängt auf die Wand."], 1, "A fixed location answers wo? and uses the dative."),
    q("Which sentence describes movement?", ["Ich hänge das Bild an der Wand.", "Ich hänge das Bild bei der Wand.", "Ich hänge das Bild an die Wand."], 2, "Movement answers wohin? and uses the accusative."),
    ...
    q("Choose the correct comparative sentence.", ["Deutsch ist mehr leicht als Mathematik.", "Deutsch ist leichter als Mathematik.", "Deutsch ist am leichter als Mathematik."], 1, "The comparative is leichter and comparisons use als."),
    q("Choose the correct relative clause.", ["Das ist der Mann, die mir geholfen hat.", "Das ist der Mann, der hat mir geholfen.", "Das ist der Mann, der mir geholfen hat."], 2, "Der refers to der Mann and the verb comes last."),
...
export default function B1Day0OrientationKnowledgeTestWorkbookPage() {
  return (
    <div style={{ display: "grid", gap: 16 }}>
      <Day0OrientationVideoPanel level="B1" />
