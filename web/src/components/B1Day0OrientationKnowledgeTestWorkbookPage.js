  ...
  return (
    <div style={{ ...styles.container, display: "grid", gap: 16 }}>
      <div style={{ ...styles.card, display: "grid", gap: 8 }}>
        ...
        <h1 style={{ ...styles.title, marginBottom: 0 }}>Day 0 Workbook (B1): Orientation + Knowledge Test</h1>
        <p style={{ ...styles.subtitle, margin: 0 }}>
          Use this Day 0 workbook for B1 to understand the learning workflow and self-check your basics before Day 1.
        </p>
      </div>

      <SectionCard title="Part 1: Orientation (Read first)">
        <ul style={{ margin: 0, paddingLeft: 20, display: "grid", gap: 6 }}>
          <li>This level targets independent communication and stronger exam readiness from the first week.</li>
