...
const summaries = {
  21: { title: "Migration und Teilhabe: Ankommen als Prozess verstehen", intro: "Dieses C1-Kapitel behandelt Migration als längeren Prozess der gesellschaftlichen Teilhabe. Der Fokus liegt auf Sprache, Anerkennung, Beratung, Bildung, Arbeit und sozialen Kontakten.", points: ["Beschreibe Migration nicht als einmaliges Ereignis, sondern als Entwicklung.", "Nutze temporale und kausale Strukturen, um Schritte und Hürden zu erklären.", "Eine starke C1-Antwort verbindet individuelle Anstrengung mit institutioneller Unterstützung."], vocabulary: ["die Teilhabe", "die Anerkennung", "Sprachförderung", "bürokratische Hürden", "soziale Kontakte"] },
  22: { title: "Politik und Mitbestimmung: Demokratie sachlich diskutieren", intro: "Dieses C1-Kapitel betrachtet politische Beteiligung, Verantwortung und demokratische Bildung. Wichtig ist, Aussagen distanziert wiederzugeben und Beteiligung differenziert zu bewerten.", points: ["Gib politische Aussagen sachlich mit indirekter Rede wieder.", "Nutze Distanzmarker, um Positionen nicht unkritisch zu übernehmen.", "Eine starke C1-Antwort zeigt, dass Mitbestimmung Rechte, Information und Verantwortung braucht."], vocabulary: ["Mitbestimmung", "politische Bildung", "indirekte Rede", "laut", "Verantwortungsbewusstsein"] },
  23: { title: "Freizeit und Work-Life-Balance: Grenzen bewusst schützen", intro: "Dieses C1-Kapitel verbindet Erholung, Arbeit, Flexibilität und Lebensqualität. Ziel ist eine ausgewogene Bewertung von Freiheit, Belastung und klaren Grenzen.", points: ["Bewerte flexible Arbeit mit Chancen und Risiken.", "Nutze konzessive und finale Strukturen, um Einwände und Ziele zu verbinden.", "Eine starke C1-Antwort erklärt Verantwortung von Beschäftigten und Unternehmen."], vocabulary: ["Work-Life-Balance", "Erreichbarkeit", "Erholung", "Grenzen setzen", "Lebensqualität"] },
};
...
export default function C1Day21To23GuidedLessonPage({ lesson, canonicalLesson = null }) {
