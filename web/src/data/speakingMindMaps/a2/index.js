...
const berufUndKarriereBranches = [
  branch(
    "beruf",
    "Beruf",
    "topic",
    ["Berufsname", "Arbeitsplatz", "Branche"],
    "Was ist Ihr Beruf und wo arbeiten Sie?",
    "Ich bin ... und arbeite ...",
    "Ich bin Verkäuferin und arbeite in einem großen Einkaufszentrum.",
  ),
  branch(
    "aufgaben",
    "Aufgaben",
    "detail",
    ["Tätigkeiten", "Kunden", "Verantwortung"],
    "Welche Aufgaben haben Sie?",
    "Zu meinen Aufgaben gehören ...",
    "Zu meinen Aufgaben gehören die Kundenberatung und die Organisation von Bestellungen.",
  ),
  branch(
    "weg-zum-beruf",
    "Weg zum Beruf",
    "example",
    ["Ausbildung", "Praktikum", "Bewerbung"],
    "Wie sind Sie zu diesem Beruf gekommen?",
    "Nach meiner Ausbildung / meinem Praktikum ...",
    "Nach meiner Ausbildung habe ich ein Praktikum gemacht und mich dann um diese Stelle beworben.",
  ),
  branch(
    "staerken",
    "Stärken",
    "opinion",
    ["teamfähig", "zuverlässig", "organisiert"],
    "Welche Stärken helfen Ihnen bei der Arbeit?",
    "Bei meiner Arbeit hilft mir, dass ich ...",
    "Bei meiner Arbeit hilft mir, dass ich zuverlässig bin und gut im Team arbeiten kann.",
  ),
  branch(
    "zukunft",
    "Zukunft",
    "closing",
    ["Weiterbildung", "Karriereziel", "in fünf Jahren"],
    "Was möchten Sie in Zukunft machen?",
    "In Zukunft möchte ich ...",
    "In Zukunft möchte ich eine Weiterbildung machen und mehr Verantwortung übernehmen.",
  ),
];

const apothekeBranches = [
  branch(
    "problem",
    "Problem",
    "topic",
    ["seit wann", "Beschwerden", "stark"],
    "Warum gehen Sie in die Apotheke?",
    "Guten Tag. Ich fühle mich seit ... nicht gut.",
    "Guten Tag. Ich fühle mich seit gestern nicht gut und brauche Ihre Hilfe.",
  ),
  branch(
    "symptome",
    "Symptome",
    ...
    "Ich habe ...",
    "Ich habe Husten und Halsschmerzen und außerdem leichtes Fieber.",
  ),
  branch(
    "medikament-rat",
    "Medikament und Rat",
    "example",
    ["Tabletten", "Hustensaft", "empfehlen"],
    "Welches Medikament oder welchen Rat brauchen Sie?",
    "Ich brauche etwas gegen ...",
    "Ich brauche etwas gegen den Husten. Was würden Sie mir empfehlen?",
  ),
  branch(
    "fragen",
    "Fragen",
    "opinion",
    ["Dosierung", "Nebenwirkungen", "Rezept"],
    "Was müssen Sie über das Medikament fragen?",
    "Wie oft soll ich ...?",
    "Wie oft soll ich das Medikament nehmen, und gibt es Nebenwirkungen?",
  ),
  branch(
    "abschluss",
    "Abschluss",
    "closing",
    ["verstanden", "danke", "Auf Wiedersehen"],
    "Wie beenden Sie das Gespräch höflich?",
    "Vielen Dank für ...",
...
const topics = [
  ...
  [14, "a2-day-14-beruf-karriere", "Beruf und Karriere", "Was ist Ihr Beruf, wie sind Sie zu diesem Job gekommen und was möchten Sie in Zukunft machen?", ["Beruf", "Aufgaben", "Weg zum Beruf", "Stärken", "Zukunft"], berufUndKarriereBranches],
  ...
  [17, "a2-day-17-apotheke", "In die Apotheke gehen", "Sie sind in der Apotheke. Was sagen und fragen Sie?", ["Problem", "Symptome", "Medikament und Rat", "Fragen", "Abschluss"], apothekeBranches],
