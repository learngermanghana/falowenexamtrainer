export const WRITING_PROMPTS = {
  A1: [
    ...
    },
    {
      ...
      Punkte: ["Wo sind Sie?", "Wie ist das Wetter?", "Was machen Sie morgen?"],
    },
    {
    ...
    {
      Thema:
        "Sie möchten ein Buch in der Bibliothek ausleihen. Schreiben Sie eine Nachricht an die Bibliothek.",
      Punkte: [
        "Warum schreiben Sie?",
    ...
    },
    {
      ...
      Punkte: ["Warum schreiben Sie?", "Wie ist das Meer?", "Was machen Sie heute?"],
    },
    {
  ...
  A2: [
    {
      ...
      Punkte: ["Was haben Sie gekauft?", "Was ist das Problem?", "Was erwarten Sie?"],
    },
    {
    ...
    },
    {
      ...
      Punkte: ["Was ist Ihr Hobby?", "Wie oft machen Sie es?", "Warum mögen Sie es?"],
    },
    {
      Thema:
        "Schreiben Sie eine E-Mail an Ihren Chef und erklären Sie, warum Sie heute zu spät kommen.",
      Punkte: [
        "Warum schreiben Sie?",
        "Was ist passiert?",
  ...
  B1: [
    {
      Thema:
        "Schreiben Sie einen Leserbrief an eine Zeitung über die Umweltverschmutzung in Ihrer Stadt.",
      Punkte: [
        "Warum schreiben Sie?",
    ...
    {
      Thema:
        "Schreiben Sie eine E-Mail an einen Reiseveranstalter und beschweren Sie sich über Ihren Urlaub.",
      Punkte: [
    ...
    {
      Thema:
        "Schreiben Sie eine E-Mail an Ihren Professor und bitten Sie um eine Verlängerung der Abgabefrist.",
      Punkte: [
    ...
    {
      Thema:
        "Schreiben Sie eine E-Mail an einen Freund und erzählen Sie von Ihrem Umzug in eine andere Stadt.",
      Punkte: [
    ...
    {
      Thema:
        "Schreiben Sie einen Brief an Ihre Gemeinde und schlagen Sie ein neues Sportzentrum vor.",
      Punkte: [
    ...
    {
      Thema:
        "Schreiben Sie eine E-Mail an eine Firma und bewerben Sie sich um ein Praktikum.",
      Punkte: [
        "Was studieren Sie?",
    ...
    {
      Thema:
        "Schreiben Sie einen Brief an einen Freund und erzählen Sie von einem kulturellen Erlebnis.",
      Punkte: [
        "Was haben Sie erlebt?",
  ...
  B2: [
    {
      Thema:
        "Schreiben Sie einen Bericht an Ihren Vorgesetzten über die Ergebnisse einer Marktanalyse.",
      Punkte: [
    ...
    {
      Thema:
        "Verfassen Sie eine formelle E-Mail an einen Geschäftspartner, um eine Verzögerung im Projekt zu erklären.",
      Punkte: [
    ...
    {
      Thema:
        "Schreiben Sie eine Stellungnahme für die Personalabteilung zur Verbesserung der Arbeitsbedingungen.",
      Punkte: [
    ...
    {
      Thema:
        "Erstellen Sie eine Einladung zu einem Workshop für Mitarbeiter über digitales Marketing.",
      Punkte: [
    ...
    {
      Thema:
        "Schreiben Sie einen Bericht über die Ergebnisse einer Kundenumfrage für die Geschäftsleitung.",
      Punkte: [
  ...
  C1: [
    {
      Thema:
        "Verfassen Sie eine Analyse für ein Fachjournal über die Auswirkungen der Globalisierung auf mittelständische Unternehmen.",
      Punkte: [
    ...
    {
      Thema:
        "Schreiben Sie ein Gutachten für eine Kommune zur Integration erneuerbarer Energien in die städtische Infrastruktur.",
      Punkte: [
    ...
    {
      Thema:
        "Verfassen Sie einen Kommentar für eine Zeitung über die Bedeutung lebenslangen Lernens in der modernen Arbeitswelt.",
      Punkte: [
    ...
    {
      Thema:
        "Schreiben Sie einen Projektvorschlag für eine internationale Kooperation in der Forschung.",
      Punkte: [
