...
const c1Day10IntegrationUndGesellschaft = makeLesson({
  ...
  explanation: [
    ...
    "Auf C1-Niveau sollst du Integration nicht nur als persönliches Bemühen beschreiben. Du solltest erklären, welche Rolle Institutionen, Schulen, Arbeitgeber, Medien, Nachbarschaft und Politik spielen.",
    ...
    "Eine starke Antwort trennt Bericht und Kommentar: Zuerst gibst du neutral wieder, was eine Quelle sagt; danach ordnest du diese Aussage mit deiner eigenen Bewertung ein.",
  ...
  grammarLesson: {
    ...
    explanation: [
      ...
      "Bei Integrationsthemen ist diese Trennung besonders wichtig, weil politische, wissenschaftliche und persönliche Aussagen schnell vermischt werden können. Saubere Quellenmarker machen deinen Text glaubwürdiger.",
    ],
    rules: [
      ...
      "Ergänze nach der Wiedergabe eine Bewertung: Diese Einschätzung überzeugt, weil ... / Diese Position greift zu kurz, da ...",
    ],
    examples: [
      ...
      "Diese Einschätzung erscheint überzeugend, weil Teilhabe ohne faire Bildungs- und Arbeitschancen kaum möglich ist.",
    ],
    miniExercise: "Forme in indirekte Rede um: 1) Die Expertin sagt: Sprache ist wichtig. 2) Der Verband erklärt: Viele Menschen haben keinen gleichen Zugang. 3) Die Studie zeigt: Es gibt strukturelle Hindernisse. 4) Die Initiative fordert: Die Politik muss mehr Begegnungsräume schaffen. Ergänze danach zu jeder Aussage einen kurzen eigenen Kommentar.",
    knowledgeTest: [
      {
