...
const A2_ENTRIES = [
  ["1.1", "Small Talk"],["1.2", "Personen beschreiben"],["1.3", "Dinge und Personen vergleichen"],["2.4", "Wo möchten wir uns treffen?"],["2.5", "Was machst du in deiner Freizeit?"],["3.6", "Möbel und Räume kennenlernen"],["3.7", "Eine Wohnung suchen"],["3.8", "Rezepte und Essen"],["4.9", "Urlaub"],["4.10", "Tourismus und traditionelle Feste"],["4.11", "Unterwegs: Verkehrsmittel vergleichen"],["5.12", "Mein Traumberuf"],["5.13", "Ein Vorstellungsgespräch"],["5.14", "Beruf und Karriere"],["6.15", "Mein Lieblingssport"],["6.16", "Wohlbefinden und Entspannung 6.16"],["6.17", "Einladung und Vorschläge"],["7.18", "Im Restaurant bestellen"],["7.19", "Gesunde Ernährung"],["7.20", "Feste und Traditionen"],["8.21", "In der Stadt orientieren"],["8.22", "Wie war dein Wochenende?"],["9.23", "Wie kommst du zur Schule oder zur Arbeit?"],["9.24", "Einen Urlaub planen"],["9.25", "Tagesablauf"],["10.26", "Gefühle beschreiben"],["10.27", "Digitale Kommunikation"],["10.28", "Über die Zukunft sprechen"],
