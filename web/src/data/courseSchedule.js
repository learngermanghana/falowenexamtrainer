...
const A2_SCHEDULE = [
  ...
  {
    day: 2,
    topic: "Small Talk 1.2 (Group Practice)",
    chapter: "1.2",
    goal: "Prepare for class discussion with speaking, writing, reading, and listening tasks.",
    assignment: true,
    instruction: "Open the in-app workbook with 4 tabs and submit your answers in the assignment section.",
    grammar_topic: "Small Talk: greetings, common topics, and polite conversation",
    video: "https://youtu.be/r-DuOo0vrqc",
    youtube_link: "https://youtu.be/r-DuOo0vrqc",
    grammarbook_link: "/campus/course/a2-starter-conjunctions-day-1",
    workbook_link: "/campus/course/a2-day-2-small-talk-workbook",
  },
  {
