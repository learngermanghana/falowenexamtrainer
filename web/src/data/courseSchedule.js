...
const A2_SCHEDULE = [
  ...
  },
  {
    ...
    workbook_link: "/campus/course/a2-day-1-small-talk-workbook",
  },
  {
    day: 2,
  ...
  },
  {
    ...
    youtube_link: "https://youtu.be/wV45Md6nSgY",
  ...
  },
  {
    ...
    youtube_link: "https://youtu.be/8605_yumfoM",
  ...
  },
  {
    ...
    youtube_link: "https://youtu.be/eP4NeBmmZF8",
  ...
  },
  {
    ...
    youtube_link: "https://youtu.be/yOfTCQDn_JM",
  ...
  },
  {
    ...
    chapter: "5.14",
    assignment: true,
    goal: "Discuss your current profession, your career path, and your future plans with confidence.",
    instruction:
  ...
  },
  {
    ...
    youtube_link: "https://youtu.be/P_ruQxHKzPg",
  ...
  },
  {
    ...
    grammarbook_link: "/campus/course/einen-urlaub-planen-9-24-final-a2-grammar-notes",
  ...
  },
  {
    ...
    chapter: "9.25",
    goal: "Describe a daily routine with clear time expressions and sequence words.",
    assignment: true,
    instruction: "Watch the video, review grammar notes, and complete all four workbook parts in-app. Submit final answers in the assignment area.",
  ...
  },
  {
    ...
    chapter: "10.26",
    goal: "Gefühle in verschiedenen Situationen klar beschreiben und passende Redemittel sicher anwenden.",
    assignment: true,
    instruction: "Arbeite alle vier Teile im in-app Workbook durch. Reiche Antworten im Abgabebereich ein; bewertet werden Lesen und Schreiben.",
  ...
  },
  {
    ...
    chapter: "10.27",
    goal: "Digitale Kommunikationsmittel im Alltag sicher beschreiben, vergleichen und bewerten.",
    assignment: true,
    instruction: "Nutze das in-app Workbook für alle vier Teile (Sprechen, Schreiben, Lesen, Hören). Reiche finale Antworten nur im Abgabebereich ein.",
  ...
  },
  {
    ...
    chapter: "10.28",
    goal: "Discuss wishes, dreams, and future plans clearly across work, family, travel, and education contexts.",
    assignment: true,
    instruction: "Use the in-app workbook for all four parts (Sprechen, Schreiben, Lesen, Hören). Submit final answers only in the submission area.",
...
const c1Schedule = [
  ...
  {
    day: 3,
    topic: "Medien und Informationskompetenz",
    chapter: "1.3",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 4,
    topic: "Beziehungen und Teamarbeit",
    chapter: "1.4",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 6,
    topic: "Gesundheit und Lebensstil",
    chapter: "2.1",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 8,
    topic: "Wohnen und Stadtentwicklung",
    chapter: "2.3",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 10,
    topic: "Integration und Gesellschaft",
    chapter: "2.5",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 15,
    topic: "Bildung und lebenslanges Lernen",
    chapter: "3.5",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 17,
    topic: "Umwelt und Verantwortung",
    chapter: "4.2",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 18,
    topic: "Gesellschaft und Zusammenhalt",
    chapter: "4.3",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 22,
    topic: "Politik und Mitbestimmung",
    chapter: "5.2",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 23,
    topic: "Freizeit und Work-Life-Balance",
    chapter: "5.3",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 24,
    topic: "Mobilität und Infrastruktur",
    chapter: "5.4",
    goal: "",
    instruction: "",
    assignment: true,
  ...
  {
    day: 27,
    topic: "Digitalisierung und Verwaltung",
    chapter: "6.2",
    goal: "",
    instruction: "",
    assignment: true,
...
const RAW_COURSE_SCHEDULES = {
  A1: [
    ...
    {
      day: 3,
      topic: "Personal Pronouns and Verb Conjugation + Introducing Yourself",
      chapter: "1.1_1.2",
      goal:
      ...
      grammar_topic: "Personal Pronouns and Verb Conjugation + Introducing Yourself",
      schreiben_sprechen: {
        chapter: "1.1",
    ...
    },
    {
      ...
      lesen_hören: {
        ...
        youtube_link: "https://youtu.be/qrkQJc5kQJQ",
    ...
    },
    {
      ...
      lesen_hören: {
        ...
        youtube_link: "https://youtu.be/hktvDESwX3k",
        assignment: true,
    ...
    },
    {
      ...
      instruction:
        "This chapter has no assignment. Read the grammar lesson notes and use the in-app checks for self-practice.",
  ...
  B2: [
    ...
    },
    {
      ...
      lesen_hören: {
        ...
        youtube_link: "https://youtu.be/ZfCAaLGV2c4",
    ...
    },
    {
      ...
      topic: "Integration und Gesellschaft",
      chapter: "2.5",
      goal: "Analysieren Sie, wie Integration und gesellschaftlicher Zusammenhalt langfristig gelingen können.",
      instruction: "Schauen Sie das Video, wiederholen Sie die Grammatik und bearbeiten Sie das Arbeitsbuch.",
      grammar_topic: "Konjunktiv I in Bericht und Kommentar",
      assignment: true,
      lesen_hören: {
        video: "",
        youtube_link: "",
    ...
    },
    {
      ...
      topic: "Freizeit und Kultur",
      chapter: "3.2",
      goal: "Diskutieren Sie, wie Freizeit- und Kulturangebote die Lebensqualität in Städten beeinflussen.",
      instruction: "Schauen Sie das Video, wiederholen Sie die Grammatik und bearbeiten Sie das Arbeitsbuch.",
      grammar_topic: "Erweiterte Vergleichsformen",
      assignment: true,
      lesen_hören: {
        video: "",
        youtube_link: "",
        grammarbook_link: "/campus/course/c1-day-12-freizeit-und-kultur-erweiterte-vergleichsformen-grammar-notes",
        workbook_link: "/campus/course/c1-day-12-freizeit-und-kultur-workbook",
      },
    },
    {
